 ...
 * </p>
 * <ul>
 *   <li>{@link algorithme.impl.PortSortieImpl#getValeur <em>Valeur</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PortSortieImpl extends PortImpl implements PortSortie {
	/**
	 ...
	 * @ordered
	 */
	protected static final Float VALEUR_EDEFAULT = Float.valueOf(0.0F);
	...
	protected EClass eStaticClass() {
		return AlgorithmePackage.Literals.PORT_SORTIE;
	}
	...
	public void setValeur(Float newValeur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmePackage.PORT_SORTIE__VALEUR, oldValeur, valeur));
	}
