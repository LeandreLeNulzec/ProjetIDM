		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constante_val_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constante_val_feature", "_UI_Constante_type"),
				 ScriptPackage.Literals.CONSTANTE__VAL,
				 true,
				 false,
				 false,
