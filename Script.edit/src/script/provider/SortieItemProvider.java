 ...
 * @generated
 */
public class SortieItemProvider extends PortSortieItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sortie_res_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sortie_res_feature", "_UI_Sortie_type"),
				 ScriptPackage.Literals.SORTIE__RES,
				 true,
				 false,
				 false,
