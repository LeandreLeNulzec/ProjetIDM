 ...
 * @generated
 */
public class SortieItemProvider extends ScriptElementsItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sortie_sorties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sortie_sorties_feature", "_UI_Sortie_type"),
				 ScriptPackage.Literals.SORTIE__SORTIES,
				 true,
				 false,
				 true,
				 null,
