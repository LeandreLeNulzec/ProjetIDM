...
/**
 * This is the item provider adapter for a {@link table.Colonne} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TablePackage.Literals.COLONNE__NOM,
				 true,
				 false,
				 false,
	...
	protected void addTablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Colonne_table_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Colonne_table_feature", "_UI_Colonne_type"),
				 TablePackage.Literals.COLONNE__TABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addElementTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Colonne_ElementType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Colonne_ElementType_feature", "_UI_Colonne_type"),
				 TablePackage.Literals.COLONNE__ELEMENT_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TablePackage.Literals.COLONNE__CONTRAINTES,
				 true,
				 false,
				 true,
				 null,
